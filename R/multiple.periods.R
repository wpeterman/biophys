...
#' @param max.rast A list providing the full path to all maximum temperature raster files.
#' @param min.rast A list providing the full path to all minimum temperature raster files.
...
multiple.periods <- function(max.rast,min.rast,elev,hours,out="mean", ...){
  storage.stack <- stack()
